...
<html lang="en">
  ...
  <body>
    {{-- <img src="data:image/png;base64, {{ base64_encode($reservasi_group['QRCode']) }} "> --}}
    {{-- <center> <img src="{{$reservasi_group->group_code}}.png" alt="{{$reservasi_group->group_code}}.png"></center> --}}
    
    {{-- {!! QrCode::format('png')->size(200)->generate($reservasi_group->group_code) !!} --}}

    {{-- <img src="{{ asset('/qrcodes'.$reservasi_group->group_code.".png") }}" alt="test"> --}}
